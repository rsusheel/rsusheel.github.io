...
var observerTwelve = new IntersectionObserver(
    (entry) => {
        ...
        }else if(bbb.innerHTML === '<span class="thisis">THIS IS MY</span><span class="portfolio">PORTFOLIO</span><a class="resume-pg" href="resume.html">Resume</a>' && entry[0].intersectionRatio < 0.6){
            document.getElementsByClassName('two-block')[0].innerHTML = "AND";
        }
